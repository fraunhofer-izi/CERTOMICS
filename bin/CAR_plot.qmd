...
ax.set_xticklabels(samples, rotation=45, fontsize=14)

# Axis labels & title with larger font
ax.set_xlabel("Sample", fontsize=16)
ax.set_ylabel("Estimated Read Counts", fontsize=16)
ax.set_title("CAR Read Counts per Sample", fontsize=18)
...
ax.legend(title="CAR", fontsize=12, title_fontsize=14)
