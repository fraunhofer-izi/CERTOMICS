...
ax.set_xticklabels(samples, rotation=45, fontsize=18)

# Axis labels & title with larger font
ax.set_xlabel("Sample", fontsize=20)
ax.set_ylabel("Estimated Read Counts", fontsize=20)
...
ax.legend(title="CAR", fontsize=14, title_fontsize=16, framealpha=0.7)
