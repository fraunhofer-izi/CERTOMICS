...
# script copied and modified from https://www.10xgenomics.com/support/software/cell-ranger/downloads/cr-ref-build-steps#human-ref-2020-a

# input:
#   $1: src_fa
#   $2: src_gtf
#   $3: car_fa - if 0 then no car_fa
#   $4: car_gtf - if 0 then no car_gtf
#   $5: task.cpus
